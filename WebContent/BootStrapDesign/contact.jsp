...
<head>
    ...
    <title>Contact Me - No Wait Services</title>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Contact
                        <strong>No Wait Services</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-4">
                    <p>Phone:
                        <strong>678.237.2992</strong>
                    </p>
                    <p>Email:
                        <strong><a href="najaestevenson@gmail.com">Najaestevenson@gmail.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>2174 Stevenson Home
                            <br>Atlanta, GA 30045</strong>
                    </p>
                </div>
